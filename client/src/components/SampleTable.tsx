...
// const deezerRows = [
//   createDeezerData("TestTitle", "TestArtist", "TestAlbum"),
//   createDeezerData("Time Travel ", "Casey Tatum", "Groban Sings Casey"),
// ]
...
//   const [orderBy, setOrderBy] = React.useState<keyof DeezerData>("title");
...
//       const newSelecteds = deezerRows.map((n) => n.title);
...
export default function EnhancedTable() {
  ...
  const deezerRows = [
    musicAppState.deezerData.map((songData: any) => {
